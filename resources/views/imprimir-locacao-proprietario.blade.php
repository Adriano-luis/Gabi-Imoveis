...
<section class="imprimir">
    <form action="">
        ...
        <section class="alinhamento-texto">
            ...
            Cômodos:<input style='width: 2rem'>(<input style='width: 85%'>)<br>
        ...
        <section class="alinhamento-texto">
            ...
            Telefone: (<input style='width: 1.4rem'>) <input style='width: auto'> Res: (<input style='width: 1.4rem'>) <input style='width: auto'><br>
