...
@section('content')
    <section class="parados">
        ...
        <a class="btn btn-primary" data-toggle="collapse" href="#tabelaLoc" role="button" aria-expanded="false" aria-controls="collapse">
            Locação
        </a><br/><br/>
        ...
        <a class="btn btn-primary" data-toggle="collapse" href="#collapseVen" role="button" aria-expanded="false" aria-controls="collapse">
            Vendas
        </a>
