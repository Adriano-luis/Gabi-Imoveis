                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        <input type="number" name="qttdCom" class="form-control" id="exampleInputPassword1" placeholder="Cômodos">
                    </div>
                  <div class="row">
                    <div class="form-group mx-1">
                  ...
                  <div class="form-group mx-1">
                        <label for="exampleInputPassword1">Varanda/sacada</label>
                        <input type="number" name="varanda" class="form-control" id="exampleInputPassword1" placeholder="Varanda/sacada">
                  </div>
