        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" name="valor" class="form-control" id="valor" value="{{$dados ? $dados->valor: ''}}" placeholder="Qual o valor de aluguel do imóvel?">
                </div><br> 
                <h5>Endereço</h5>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="aguaLuz" {{$dados && $dados->aguaLuzSeparado == 'Sim' ? "checked='checked'": ''}}>
                    <label name="aguaLuz" class="form-check-label">Agua e luz separada?</label>
                </div>
                <br>
                <div class="form-group col-lg-2">
                    <label for="rgi">RGI</label>
                    <input  type="text" name="rgi" class="form-control" id="rgi" value="{{$dados ? $dados->RGI: ''}}" placeholder="RGI">
                </div>
                <div class="form-group col-lg-2">
                    <label for="instalacao">Instalação</label>
                    <input type="text" name="instalacao" class="form-control" id="instalacao" value="{{$dados ? $dados->instalacao: ''}}" placeholder="Instalação">
                </div>
                <div class="form-group col-lg-2">
                    <label for="iptu">IPTU</label>
                    <input type="text" name="iptu" class="form-control" id="iptu" value="{{$dados ? $dados->IPTU: ''}}" placeholder="IPTU">
                </div>
                <br>
                <div class="form-check">
                ...
                <br>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="individual" {{$dados && $dados->individual == 'Sim' ? "checked='checked'": ''}}>
                    <label name="individual" class="form-check-label">Individual?</label>
                </div>
                <br>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="mobiliado" {{$dados && $dados->mobilhado == 'Sim' ? "checked='checked'": ''}}>
                    <label name="mobiliado" class="form-check-label">Mobiliado?</label>
                </div>
                <br>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="pet" {{$dados && $dados->pet == 'Sim' ? "checked='checked'": ''}}>
                    <label name="pet" class="form-check-label">Aceita Pet?</label>
                </div>
                <br>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="resiCheck" {{$dados && $dados->individual == 'residencial' ? "checked='checked'": ''}}>
